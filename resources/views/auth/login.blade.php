                            ...
                            <div class="row m-0">
                                ...
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2">
                                        ...
                                        <button type="submit" class="btn btn-primary w-100 mb-5 btn-inline">Submit </button>
                                    </form>
                                    <div class="divider">
                                                <div class="divider-text">OR</div>
                                            </div>
                                        <a href="{{route('register')}}"><button  class="btn btn-primary w-100 mb-5 btn-inline">Register </button></a>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body pt-1">
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="text-right"><a href="{{ route('password.request') }}"
                                                                       class="card-link">Reset Password?</a></div>
                                        </div>
                                        <button type="submit" class="btn btn-primary w-100 mb-5 btn-inline">Enter </button>
                                    </form>
                                </div>
                            </div>
